...
var feed = new Instafeed({
	limit:12,
	accessToken: 'IGQVJVM09KX3VkMVI5VVlVTEpLN253N3hmay15c3duTE1lYVZAxSml4b1hCdGgzdjJFODJIVHlRTjlVbmlzSnMtX3JFOHlkWDZABekc3TmljUnpodk1FY29WYW5FZATlnRVcyRm9rd19sb1hrdUpQWnNuWgZDZD',
	// target:'instafeed',
	debug: true,
	template: '<div class="flex image-wrapper col-md-3 col-sm-12 col-xs-12"><a href="{{link}}" title="{{caption}}" target="_blank"><img src="{{image}}" alt="{{caption}}" class="img-fluid"/></a></div>'
});
feed.run();
var d = new Date();
var n = d.getFullYear();
